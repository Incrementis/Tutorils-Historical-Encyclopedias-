...
LPF ADD_ITEM_EFFECT
	INT_VAR
		...
		parameter1 		= 12044 // "Clairvoyance" is displayed(strref 12044 from dialog.tlk)
...
LPF ADD_ITEM_EFFECT
	INT_VAR
		...
		parameter1 		= ((205 << 8) + (205 << 16) + (250 << 24)) // Color is "Light Sky Blue" ((red << 8) + (green << 16) + (blue << 24))
...
LPF ADD_ITEM_EFFECT
	INT_VAR
		...
		parameter2		= 21	// Conjure earth
		duration 		= 1		// 1 round = 6 seconds(How long it takes until effect is displayed)
		header			= 1 	// Add effect to only x item abilities(0=every item ability)
		probability1 	= 100	// x% chance of activating the effect
END
// VALUES TO ITEM HEADER EFFECT
